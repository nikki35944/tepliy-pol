...
//    добавление класса к изображениям
    $('.attachment-woocommerce_thumbnail').addClass('primary-img');
//    добавление класса к "добавить в корзину"
    $('.button.add_to_cart_button').addClass('add-cart');
//    страница single product, класс для блока summary
    $('.single-product .quantity').addClass('box-quantity');
    $('.single-product .product_meta').addClass('product-link');
